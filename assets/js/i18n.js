...
(function () {
  ...
  const I18N = {
    es: {
      ...
      "exp.urp.b3": "Contribuí, en el equipo de desarrollo, a varios módulos del nuevo sistema académico “Yachayhuasi” (matrícula, carga lectiva y no lectiva, cuadro de necesidades, dashboards, reportes), en backend (Java 17/21, Spring) y luego frontend; migré código legacy (Visual Basic, Java, PHP) a Java moderno y Python.",
    ...
    en: {
      ...
      "exp.urp.b3": "As part of the development team, contributed to several modules of the university's academic-management platform (enrollment, teaching and non-teaching load, procurement/requirements planning, dashboards, reporting), on the backend (Java 17/21, Spring) and later the frontend; migrated legacy code (Visual Basic, Java, PHP) to modern Java and Python.",
